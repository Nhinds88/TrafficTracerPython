...
cameraFeed = tools.cameraSource('http://192.168.0.137:8081/')

startPoint = tools.lineCoords(250, 0)
endPoint = tools.lineCoords(250, 600)

db = tools.dbConnnect("localhost", "root", "Delonh88", "traffictracer")

video = cv2.VideoCapture(cameraFeed)
    
tools.process_video(video, startPoint, endPoint, 'h', 800, 2, db)