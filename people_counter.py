...
entry_line = tools.lineCrossingPlacement(int(0), 'x') #Entry Start
exit_line = tools.lineCrossingPlacement(int(1000), 'x')
entry_line_Limit = tools.lineCrossingPlacement(int(600), 'x')
exit_line_Limit = tools.lineCrossingPlacement(int(0), 'x') #Entry End
