...
entryStartPoint = tools.lineCoords(0, 100)
entryEndPoint = tools.lineCoords(500, 100)

exitStartPoint = tools.lineCoords(0, 350)
exitEndPoint = tools.lineCoords(100, 350)
...
tools.process_video(video, values, motion, count1, count2, 
                    avg, entryStartPoint, entryEndPoint, 
                    exitStartPoint, exitEndPoint)
